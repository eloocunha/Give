...
import { IoMdLogOut, IoIosArrowBack } from 'react-icons/io';
import 'react-dom'
    ...
    if(empresa) {
        return(
            <div className="container-client">
                ...
                <a style={{cursor: 'pointer'}} onClick={handleGoBack}>
                    <IoIosArrowBack style={{marginTop: '10%', marginLeft: '8%'}} size={25} color='white' />
                </a>
